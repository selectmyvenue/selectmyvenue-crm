...
(function(){
 let installed=false,assignedMode=false,selectedNow=new Set(),selectionLeadId='',smvSelectionTouched=false;const clean=v=>v==null?'':String(v).trim(),norm=v=>clean(v).toLowerCase();
