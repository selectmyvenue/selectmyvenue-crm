...
(function(){
 ...
 function installWhatsAppAssignment(forceFresh=false){
   ...
   /* Keep one stable button for the whole page lifetime. Replacing it after the
      modal opens created a first-click race on phone UI. */
